...
class PromptAssembler:
    ...
    def assemble_vul_check_prompt(code,vul):
        ...
        return ret_prompt  
    def assemble_prompt_ask_title(response_vul):
        ret_prompt=response_vul+"\n"\
                +"here is the description and recommendation, please give a title for this vulnerability"
        return ret_prompt  
